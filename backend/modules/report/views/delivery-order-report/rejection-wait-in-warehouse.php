...
<div class="delivery-order-index">
    ...
    <div class="box">
        <div class="box-body">
            <?php echo $this->render('rejection-wait-in-warehouse_search', ['model' => $searchModel]); ?>
        </div>
    </div>
    <div class="box">
                    ...
                    [
                        ...
                        'buttons' => [
                            ...
                            'create_delivery_adjust_order' => function ($url, $model) {
                                if (\Yii::$app->user->getIdentity()['type'] == \backend\models\UserBackend::TYPE_SYSTEM) {
                                    return Html::a('创建调整单', '/delivery/delivery-adjust-order/create?logistic_no=' . $model->logistic_no, ['target' => '_blank']);
                                }
                            },
                        ]
                    ],
