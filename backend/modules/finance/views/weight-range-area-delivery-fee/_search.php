...
/** @var backend\models\WeightRangeAreaDeliveryFeeSearch $model */
/** @var yii\widgets\ActiveForm $form */
/* @var $cityList array */
/* @var $districtList array */
?>

<div class="customer-area-delivery-fee-search">
    ...
    <div class="row">
        <?= $form->field($model, 'customer_type', ['options' => ['class' => 'col-xs-3']])->dropDownList(\common\models\Customer::$typeList, ['prompt' => '-全部-'])->label('客户类型'); ?>
    </div>
