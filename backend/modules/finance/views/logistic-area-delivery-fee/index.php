...
/** @var common\models\LogisticAreaDeliveryFeeSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */
/* @var $cityList array */
/* @var $districtList array */
$this->title = '快递公司区域运费列表';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="logistic-area-delivery-fee-index">
    <div class="box">
        <div class="box-body">
            ...
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'value' =>
                            function ($model) {
                                return LogisticAreaDeliveryFee::getFeeName($model->fee_type);
                            },
                    ],
                    [
                        'attribute' => 'fee_rules',
                        ...
                        'value' =>
                            function ($model) {
                                return LogisticAreaDeliveryFee::getFeeRules($model->fee_rules, $model->fee_type);
                            },
                    ],
                    //'invoice_base_price',
                    //'face_order_fee',
