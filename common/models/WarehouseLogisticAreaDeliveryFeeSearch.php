...
/**
 * vSearch represents the model behind the search form of `common\models\WarehouseLogisticAreaDeliveryFee`.
 */
class WarehouseLogisticAreaDeliveryFeeSearch extends WarehouseLogisticAreaDeliveryFee
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'warehouse_id', 'logistic_id', 'is_cancel'], 'integer'],
    ...
    {
        $query = WarehouseLogisticAreaDeliveryFee::find();
