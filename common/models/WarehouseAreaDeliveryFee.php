...
/**
 * This is the model class for table "warehouse_area_delivery_fee".
 *
 ...
 */
class WarehouseAreaDeliveryFee extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'warehouse_area_delivery_fee';
    }
    ...
    {
        return [
            [['warehouse_id', 'province', 'city', 'district', 'weight', 'price', 'follow_weight', 'follow_price', 'return_rate', 'agent_rate', 'is_cancel', 'create_user', 'create_time', 'update_user', 'update_time'], 'required'],
            [['warehouse_id', 'is_cancel'], 'integer'],
